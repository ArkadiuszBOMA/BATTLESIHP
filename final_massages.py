...
def print_win_boards(board_size_len, board_size, player, competitor):
    print(game_colours["MESSE_STA"]+f"{player['name'][0]} {player['name'][1]} below a his/ her ships location map. {game_messages['S6']} = {player['bullets'][0]}"+game_colours["MESSE_END"])
    ...
    print(f'{"-" * 10}{"-" * (board_size * 2)}\n')
    print(game_colours["MESSE_STA"]+f"{competitor['name'][0]} {competitor['name'][1]} below a his/ her ships location map. {game_messages['S6']} = {player['bullets'][0]+1}"+game_colours["MESSE_END"])
